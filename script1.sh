...
#$ -j y
#$ -pe smp 8
#$ -l h_rt=10:0:0    # 24 hours runtime
...
python demo_dataset__.py --recursive_blur_gauSigma=5 --dilation_k=20 --use_fuse_mask_hm --use_origin_img      --cache_blip_filename COD_GT_woPos --attn_thr 0.9 --down_sample=0.5 --recursive 6 --recursive_coef=1 --clip_attn_qkv_strategy='kk'  --test  --use_blur --use_dilation --use_origin_neg_points --test_vis_dir='PostBoxWoPt' >> output_log_test/COD_GT_woPos_thr9e-1_s05_rcur6_coef_kk_blur_sigma5_inflateK20_mask_originImg_OriNegPt_PostBoxWoPt.log
