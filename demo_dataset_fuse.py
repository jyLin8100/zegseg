...
from utils_model import get_text_from_img, get_mask, printd, reset_params
import os
...
save_dir_name = f'{cache_blip_filename}/cfg_{args.config[:-5]}'
...
print(f'fusing: {save_dir_name.split("/")[-1]}')
